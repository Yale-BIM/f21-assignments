...
on using Google Colab such as usage limits, read the [F.A.Q](https://research.google.com/colaboratory/faq.html).

We recommend that you use Google Colab for short training exercises (e.g., task II-6 of this assignment).
...
- Report (50 pts + 3 extra pts)
    * Part I (5 pts)
    * Part II (30 pts): II-6 (10 pts) + II-7 (4 pts) + II-9 (10 pts) + II-10 (3 pts) + II-11 (3 pts)
    * Part III (15 pts + 3 extra pts): III-2 (3 pts) + III-3 (5 pts) + III-4 (7 pts) + III-6 (3 pts extra credit)
- Code (50 pts + 5 extra pts)
